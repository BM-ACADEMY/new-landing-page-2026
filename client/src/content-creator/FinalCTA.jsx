...
export default function FinalCTA({ onBookClick }) {
  return (
    <section className="py-[58px] text-center relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-pink-brand via-violet-brand to-blue-brand opacity-8"></div>
