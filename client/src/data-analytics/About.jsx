      ...
      <div className="max-w-[1080px] mx-auto px-5" ref={containerRef}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[18px] mt-9">
          <div className="reveal bg-panel border border-white/9 rounded-2xl p-[22px] flex gap-4 items-start">
            ...
            <div>
              <h4 className="font-sora font-bold text-[1rem] text-white">Data Analytics Lead Trainer</h4>
              <span className="block text-[0.78rem] text-pink-brand mt-[3px] mb-2 font-semibold">Data Analytics Lead Trainer</span>
              <p className="text-muted-brand text-[0.86rem] leading-relaxed">Working analyst with hands-on industry reporting and dashboarding experience.</p>
            </div>
          </div>
          <div className="reveal bg-panel border border-white/9 rounded-2xl p-[22px] flex gap-4 items-start">
            <div className="w-[54px] h-[54px] rounded-full bg-gradient-to-r from-pink-brand via-violet-brand to-blue-brand flex-shrink-0 grid place-items-center font-extrabold font-sora text-white text-[1.1rem]">
            ...
            <div>
              ...
              <p className="text-muted-brand text-[0.86rem] leading-relaxed">Practitioners mentoring every batch personally through live datasets.</p>
            </div>
          </div>
        </div>
