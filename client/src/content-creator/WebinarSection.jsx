  ...
  return (
    <section id="webinar" className="py-[58px] relative overflow-hidden">
      ...
      <div className="max-w-[800px] mx-auto px-5 text-center relative z-10">
        <span className="text-[0.78rem] font-bold tracking-[0.06em] uppercase text-pink-brand">// FREE Live Webinar </span>
        <h2 className="font-sora font-extrabold text-[1.35rem] sm:text-[1.8rem] leading-[1.14] tracking-[-0.025em] mt-3 mb-4 text-white">
          Turn Your Creativity into a Content Creation Career.
        </h2>
        <p className="text-muted-brand text-[1.02rem] mt-2 mb-8 max-w-[620px] mx-auto">
          Join our FREE Live Webinar to learn content strategy, video creation, branding, and audience growth. Perfect for beginners, students, freelancers, and aspiring creators.
        </p>
          ...
          <div className="p-5 sm:p-7 space-y-5">
            ...
            <div className="flex items-center justify-between p-4 rounded-xl border border-[#FFB020]/20 bg-[#FFB020]/[0.02] shadow-[0_0_20px_rgba(255,176,32,0.03)] relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-sora font-extrabold text-white text-[1.05rem]">July 25, 2026</div>
