...
export default function WebinarForm({ isModal = false, onClose }) {
  ...
  const handleRegister = async () => {
    ...
    const WEBHOOK_URL = "https://script.google.com/macros/s/AKfycbxdFq4WAQ16AcI3wJwH6BUiQb9Uq6X-k64NUUJedolbd6YKs0mIGuEJx1BAmu5biWU/exec";
    ...
    if (WEBHOOK_URL) {
      fetch(WEBHOOK_URL, {
        ...
        body: JSON.stringify({
          ...
          Message: "Content Creator Webinar - " + message.trim(),
          ...
          {!isModal && (
            <>
              ...
              <p className="text-muted-brand text-[0.94rem] mt-3 mb-[22px]">
                Learn the exact roadmap to start your Content Creator career. Fill out the form below to secure your spot.
              </p>
            </>
          )}
