        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[18px]">
          <div className="reveal bg-panel border border-white/9 rounded-2xl p-[22px] flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-muted-brand text-[0.86rem] leading-relaxed">States your name, program (WordPress Pro), duration, and modules covered — verifiable directly with BM Academy.</p>
            </div>
          </div>
          <div className="reveal bg-panel border border-white/9 rounded-2xl p-[22px] flex gap-4 items-start">
            <div className="w-[54px] h-[54px] rounded-full bg-gradient-to-r from-pink-brand via-violet-brand to-blue-brand flex-shrink-0 grid place-items-center font-extrabold font-sora text-white text-[1.1rem]">
            ...
            <div>
              ...
              <p className="text-muted-brand text-[0.86rem] leading-relaxed">A record of the real WordPress websites and e-commerce stores you completed during training — proof of hands-on experience, not just theory.</p>
            </div>
          </div>
        </div>
      </div>
