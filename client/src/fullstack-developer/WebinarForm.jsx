...
export default function WebinarForm({ isModal = false, onClose }) {
  ...
  const handleRegister = async () => {
    ...
    // const WEBHOOK_URL = "https://script.google.com/macros/s/AKfycbw-jifZHSU8yVgBQNBU9F16iEDnI_JZdexDyZBgS3Evs6IBYRX0NFG9n3rUWsfJ9TUwzw/exec";
          ...
          {!isModal && (
            <>
              ...
              <p className="text-muted-brand text-[0.94rem] mt-3 mb-[22px]">
                Learn the exact roadmap to start your Full Stack Development career. Fill out the form below to secure your spot.
              </p>
            </>
          )}
