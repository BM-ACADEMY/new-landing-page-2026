    ...
    <section id="webinar" className="py-[58px] relative overflow-hidden bg-bg-dark">
      ...
      <div className="max-w-[800px] mx-auto px-5 text-center relative z-10">
        ...
        <h2 className="font-sora font-extrabold text-[1.35rem] sm:text-[1.8rem] leading-[1.14] tracking-[-0.025em] mt-3 mb-4 text-white reveal">
          Build stunning, responsive websites with WordPress—even if you're a beginner.
        </h2>
        <p className="text-[#C8C2DC] text-[0.96rem] sm:text-[1.05rem] leading-relaxed max-w-[700px] mx-auto mb-10 reveal">
          Attend our FREE Live Webinar to discover website design, theme customization, plugins, WooCommerce, SEO basics, and how to launch websites for clients or your own business.
        </p>
          ...
          <div className="p-5 sm:p-7 space-y-5">
            ...
            <div className="flex items-center justify-between p-4 rounded-xl border border-[#FFB020]/20 bg-[#FFB020]/[0.02] shadow-[0_0_20px_rgba(255,176,32,0.03)] relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-sora font-extrabold text-white text-[1.05rem]">August 15, 2026</div>
