...
export default function BookDemo({ selectedProgram, isModal = false, onClose }) {
  ...
  const handleBook = async () => {
    ...
    // Deploy your Google Apps Script Web App for WordPress Pro Demo Booking and add the URL here:
    const WEBHOOK_URL = "https://script.google.com/macros/s/AKfycby6nsLWk2vANGAVHwA3w8cDnTZglCJMM7kKCOImbLWbNvz5WN0iArtlrsKF9X1KHoTosw/exec";
