  ...
  const steps = [
    {
      id: 1,
      tag: "BEFORE",
      title: "Dreaming of Building Websites?",
      desc: "No coding knowledge? Start your journey with WordPress.",
      bg: "bg-[#f4f1eb]",
    ...
    },
    {
      id: 2,
      tag: "FOUNDATION",
      title: "Master WordPress Essentials",
      desc: "Domains, Hosting, Installation, Dashboard & Website Structure.",
      bg: "bg-[#fbf0f2]",
    ...
    },
    {
      ...
      desc: "Themes, Elementor, Responsive Design & User Experience.",
      bg: "bg-[#fbf0f2]",
      border: "border-[#ebd0d6]",
      textColor: "text-[#5c1d2e]",
      tagColor: "text-[#a04a60]"
    },
    {
      id: 4,
      tag: "DEVELOP",
      title: "Build Powerful Business Websites",
      desc: "Blogs, Corporate Sites, Landing Pages & WooCommerce Stores.",
      bg: "bg-[#fbf0f2]",
      border: "border-[#ebd0d6]",
      textColor: "text-[#5c1d2e]",
      tagColor: "text-[#a04a60]"
    },
    {
      ...
      desc: "SEO, Performance, Security, Maintenance & Live Deployment.",
      bg: "bg-[#fbf0f2]",
      border: "border-[#ebd0d6]",
      textColor: "text-[#5c1d2e]",
      tagColor: "text-[#a04a60]"
    },
    {
      id: 6,
      tag: "CAREER READY",
      title: "Become a Professional WordPress Developer",
      desc: "Build a strong portfolio, work with clients, and start your freelancing or full-time career.",
      bg: "bg-[#eff5eb]",
