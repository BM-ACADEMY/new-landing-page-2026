      ...
      <div className="max-w-[1080px] mx-auto px-5 grid grid-cols-1 md:grid-cols-[1.04fr_.96fr] gap-[44px] items-center relative">
        <div>
          <span className="inline-flex items-center gap-[9px] text-[0.76rem] font-semibold text-white border border-white/9 bg-white/4 px-[14px] py-[7px] rounded-full tracking-[0.02em]">
            ...
            FULL STACK DEVELOPMENT · NEW BATCH FORMING
          </span>
          <h1 className="font-sora font-extrabold text-[2rem] sm:text-[3.2rem] leading-[1.08] tracking-[-0.025em] mt-5 mb-0 text-white">
            Arts degree? Zero coding? <span className="gradtext">Become a real Full Stack Developer</span> in 6 months.
          </h1>
          <p className="text-[#C8C2DC] text-[1rem] sm:text-[1.1rem] mt-[18px] mb-[28px] max-w-[540px] leading-relaxed">
            Learn <b className="text-white"> Learn HTML, CSS, JavaScript, React, Node.js, Express.js, and MongoDB </b> by building real-world web applications—not just tutorials. Open to students and professionals from any background.  <b className="text-white"> Join our FREE Live Full Stack Development Webinar </b>to explore the complete learning roadmap, live projects, career opportunities, and how to become a job-ready Full Stack Developer.
