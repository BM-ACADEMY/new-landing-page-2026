...
export default function BookDemo({ isModal = false, onClose }) {
  ...
  const [track, setTrack] = useState('AI Tools Mastery');
  ...
  const handleBook = async () => {
    ...
    const WEBHOOK_URL = "https://script.google.com/macros/s/AKfycbwFoIJZ2kzEQHzbIUTeEBe5yOef6xTbDTJUh_hXopdtWYNmJr75ao7ltXbcQVeR4nJK/exec";

    // Fire request asynchronously and show success state immediately
    axios.post(WEBHOOK_URL, JSON.stringify({
      Name: name.trim(),
      Phone: phone.trim(),
          ...
          <div className="grid gap-[13px]">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select 
                ...
                disabled={isSubmitting}
              >
                <option value="AI Tools Mastery">AI Tools Mastery</option>
              </select>
            </div>
