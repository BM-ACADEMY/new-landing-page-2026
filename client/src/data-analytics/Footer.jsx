        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1.2fr_1.5fr] gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-brand text-[0.88rem] leading-relaxed mb-6">
              BM Academy is a multi-vertical training institute empowering students through Data Analytics, Digital Marketing, AI tools, Software Development, and Skill Training — built on integrity, innovation, and real-world skills.
            </p>
          ...
          <div>
            ...
            <div className="rounded-2xl overflow-hidden border border-white/9">
              <iframe
                src="https://maps.google.com/maps?q=BM%20Academy%20Data%20Analytics%20Kottakuppam%20Puducherry&z=16&output=embed"
                width="100%" 
                height="150" 
