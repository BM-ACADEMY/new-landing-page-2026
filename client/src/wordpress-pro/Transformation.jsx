  ...
  const steps = [
    {
      ...
      desc: "No website-building or design skill. No way to earn outside a fixed job.",
      bg: "bg-[#f4f1eb]",
    ...
    },
    {
      id: 2,
      tag: "Week 1",
      title: "First live website",
      desc: "Builds and launches a first real WordPress site. Sees that no-code really is possible.",
      bg: "bg-[#fbf0f2]",
    ...
    },
    {
      ...
      desc: "Comfortable building clean, responsive layouts clients would actually pay for.",
      bg: "bg-[#fbf0f2]",
      border: "border-[#ebd0d6]",
      textColor: "text-[#5c1d2e]",
      tagColor: "text-[#a04a60]"
    },
    {
      id: 4,
      tag: "Week 6",
      title: "First client-style project",
      desc: "Completes a full real-style client website end-to-end.",
      bg: "bg-[#fbf0f2]",
      border: "border-[#ebd0d6]",
      textColor: "text-[#5c1d2e]",
      tagColor: "text-[#a04a60]"
    },
    {
      ...
      desc: "Lands first paying client — often ₹15,000–₹25,000 per website.",
      bg: "bg-[#eff5eb]",
    ...
    },
    {
      ...
      desc: "A skill that can be done from anywhere, on their own schedule, alongside other work.",
      bg: "bg-[#eff5eb]",
      border: "border-[#cbe0bf]",
      textColor: "text-[#2d5020]",
      tagColor: "text-[#456f35]"
