    ...
    <section className="py-[58px] bg-panel border-y border-white/9">
      <div className="max-w-[1080px] mx-auto px-5">
        ...
        <p className="text-muted-brand text-[1.02rem] mt-3.5">
          Our current Digital Marketing Pro batch is live and in session at our Kottakuppam campus. Seats for the next intake are open and filling on a first-come basis — book your free 1:1 demo to check seat availability and the next start date for your batch.
        </p>
      </div>
    </section>
  );
