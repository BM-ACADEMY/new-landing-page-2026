  ...
  const steps = [
    {
      id: 1,
      tag: "Before",
      title: "Stuck with spreadsheet basics",
      desc: "Knows only basic Excel. Stuck in a low-paying admin or data-entry role with no growth path.",
      bg: "bg-[#f4f1eb]",
    ...
    },
    {
      ...
      desc: "Learns advanced Excel and dashboards. Has something concrete and demonstrable for a resume.",
      bg: "bg-[#fbf0f2]",
    ...
    },
    {
      id: 3,
      tag: "Month 2",
      title: "Querying real data",
      desc: "Writes SQL queries on real databases. Starts thinking in data, not just spreadsheets.",
      bg: "bg-[#fbf0f2]",
      border: "border-[#ebd0d6]",
      textColor: "text-[#5c1d2e]",
      tagColor: "text-[#a04a60]"
    },
    {
      ...
      desc: "Has a capstone analytics project and certificate. Walks into interviews with proof of work.",
      bg: "bg-[#fbf0f2]",
      border: "border-[#ebd0d6]",
      textColor: "text-[#5c1d2e]",
      tagColor: "text-[#a04a60]"
    },
    {
      id: 5,
      tag: "After",
      title: "First analyst job",
      desc: "Hired as a data/business analyst. Often 1.5–2x the salary of their previous job.",
      bg: "bg-[#eff5eb]",
    ...
    },
    {
      ...
      desc: "Steady income, a skill in demand across every industry, and a clear career ladder ahead.",
      bg: "bg-[#eff5eb]",
      border: "border-[#cbe0bf]",
      textColor: "text-[#2d5020]",
      tagColor: "text-[#456f35]"
